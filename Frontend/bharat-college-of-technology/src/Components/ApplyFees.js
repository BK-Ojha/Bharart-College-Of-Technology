          ...
          <Row>
            ...
            <Col xs={12} md={4} className="mx-auto mt-2">
              ...
              <Select
                ...
                onChange={handleFeesSelectedField}
                 value={feesNameOptions.find(option => option.value === selectedFeesId) || null} 
            ...
            <Col xs={12} md={4} className="mx-auto mt-2">
              ...
              <Select
                ...
                value={studentNameOption.find(option => option.value === selectedStudentId) || null}
                styles={{
                  control: (base, state) => ({
                    ...base,
                    borderColor: state.isFocused ? 'black' : base.borderColor, // ✅ dark border on focus
              ...
              <div>
                <Alert variant="dark" className="mt-2 p-4 rounded-4 shadow-sm">
                  ...
                  <p className="mb-1">
                    ...
                    the chosen course <strong>{selectedCourse?.name}</strong>
                      <>
                        {" "}(from <strong>{selectedCourse?.start_date && new Date(selectedCourse?.start_date)?.toLocaleDateString("en-GB",{
                      day:"numeric",
                      month:"long",
                      year:"numeric"
                    })}</strong> to <strong>{selectedCourse?.end_date &&
                    new Date(selectedCourse.end_date).toLocaleDateString("en-GB", {
                      day: "numeric",
                      month: "long",
                      year: "numeric"
                    })}).</strong>
